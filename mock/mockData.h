...
private:
    ...
    const vector<string> phoneNumber_clientFile = ("934738495", "947389653", "913472854");
    ...
    const vector<string> name_workshops ={"maquilhagem de olhos", "tratamento de pele", "maquilhagem total"};
